"""Background-job handler for the document quarantine/scan pipeline (T-093, D-155).
...
two job runs would only add an extra queue hop with nothing to do in between. Fail closed (D-155): a scanner
