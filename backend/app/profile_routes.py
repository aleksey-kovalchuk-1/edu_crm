"""CRM-owned phone verification for the acting user's own profile (D-161-D-163).
...
synchronously in the request handler (D-162), and no real SMS gateway is integrated (D-163,
