...
describe("filtersFromParams", () => {
  it("reads all six dimensions out of the URL", () => {
    expect(
      filtersFromParams(params("status=new&status=in_progress&priority=high&university_id=2&deadline_preset=overdue&active=true&has_checklist=false")),
    ).toEqual({
